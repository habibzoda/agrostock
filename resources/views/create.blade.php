...
@section('content')
  <div class="breadcrumb-container">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="#">Создать объяление</a></li>
    </ul>
  </div>
      ...
      <div id="content" class="col-sm-9">
        <div class="products">
          <div class="category_banner">
            <div class="row">
              <div class="col-sm-12 category-title">Создать объявление</div>
              <div class="col-sm-12 category_description"><p>
                  Разместите своё объявление в сервисе</p>
              </div>
            </div>
          </div>
            ...
            <form action="/create" method="post" enctype="multipart/form-data">
              ...
              <div class="raw">
                <div class="form-group col-sm-12 col-lg-6">
                  ...
                  <input type="text" name="title" value="" placeholder="Название продукта" id="product-name"
                         class="form-control" required>

                </div>
                <div class="form-group col-sm-12 col-lg-6">
                  <label class="control-label" for="product-price">Цена продукта</label>
                  <input type="number" name="price" value="" placeholder="Цена продукта" id="product-price"
                         class="form-control" required>
                ...
                <div class="form-group col-sm-12 col-lg-6">
                  ...
                  <textarea name="description" id="product-desc" class="form-control" required></textarea>
                </div>
              </div>
