        ...
        <div id="content" class="col-sm-9">
          <div class="products">
            <div class="category_banner">
              <div class="row">
                <div class="col-sm-12 category-title">Мои продукты</div>
                <div class="col-sm-12 category_description"><p>
                    Вывод созданных вами предложений</p>
                </div>
              </div>
            </div>

			@if (count($products) === 0)
				<p class="h5">Список ваших продуктов пуст...</p>
			@endif
              ...
              @foreach($products as $p)
                <div class="product-layout product-grid col-lg-3 col-md-6 col-sm-6 col-xs-12">
                  <div class="product-thumb">
                    ...
                    <div class="caption">
                      <h4><a href="/profile/product/{{$p->id}}">{{$p->title}}</a></h4>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-xs-12 text-right">
                  ...
                  @if($products->currentPage() < $products->lastPage())
                    ...
                    <a class="btn btn-default" href="?page={{$products->lastPage()}}">
