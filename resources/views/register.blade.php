        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="well">
              ...
              <p><strong>Войти в сервис</strong></p>

              <p>Выполните вход если уже зарегистрированы</p>
              <a href="/login" class="btn btn-primary">Продолжить</a></div>
          </div>
          <div class="col-sm-6">
            <div class="well">
              <h2>Регистрация</h2>
              ...
              <form action="/register" method="post">
                ...
                <input type="submit" value="Зарегистрироватся" class="btn btn-primary"/>
